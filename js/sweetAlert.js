!(function (t, e) {
  ...
  var Tt = {
    ...
    It = {};
  (It.text = It.email = It.password = It.number = It.tel = It.url = function (
    t,
    e
  ) {
    return (
      ...
      t && o.icon === t.icon
        ...
        ? o.icon && -1 === Object.keys(X).indexOf(o.icon)
          ? (K(
            ...
            at(n))
          : (rt(n), Wt(n, o), Ft(n, o), vt(n, o.showClass.icon))
        : at(n),
      (function (t) {
        var e = E();
  ...
  function xn(a, s, u) {
    return new Promise(function (t) {
      ...
      Ce.swalPromiseResolve.set(a, t),
        ...
        (u.toast && (u.input || u.footer || u.showCloseButton) ? vt : bt)(
          document.body,
          $["toast-column"]
        ),
        (r = a),
